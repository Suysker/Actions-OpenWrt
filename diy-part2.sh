...
#更改默认geoip和geosite
sed -i 's/github.com\/v2fly\/geoip\/releases\/download\/$(GEOIP_VER)\//github.com\/Loyalsoldier\/v2ray-rules-dat\/releases\/latest\/download\/geoip.dat/' feeds/small/v2ray-geodata/Makefile
