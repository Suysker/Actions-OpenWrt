...
sed -i 's/PKG_VERSION:=2.*/PKG_VERSION:=3.2.6/' feeds/packages/haproxy/Makefile
...
sed -i 's/BASE_TAG=v2.*/BASE_TAG=v3.2.6/' feeds/packages/haproxy/get-latest-patches.sh
