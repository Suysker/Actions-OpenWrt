...
#更改haproxy内核版本
sed -i 's/PKG_VERSION:=2.*/PKG_VERSION:=2.6.14/' feeds/packages/haproxy/Makefile
...
sed -i 's/BASE_TAG=v2.*/BASE_TAG=v2.6.14/' feeds/packages/haproxy/get-latest-patches.sh
...
sed -i 's/rise 1 fall 3 {{backup}}/rise 30 fall 3 {{backup}}  on-marked-down shutdown-sessions/' feeds/passwall/luci-app-passwall/root/usr/share/passwall/haproxy.lua
